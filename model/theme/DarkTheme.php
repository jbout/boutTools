...
namespace jbout\boutTools\model\theme;
...
/**
 * Class BoutoolsDefaultTheme
 *
 * @package jbout\boutTools\model\theme
 */
class DarkTheme extends DefaultTheme
{
     ...
     */
    const EXTENSION_ID = 'boutTools';


    /**
     * Theme's label
     */
    const THEME_LABEL = 'Dark theme';


    /**
     * Theme's id, by default label without spec chars
     */
    const THEME_ID = 'BoutDarkTheme';
        ...
        switch ($id) {
            ...
            case 'header' :
                $template = Template::getTemplate(
                    'theme/' . self::THEME_ID . '/header.tpl',
                    self::EXTENSION_ID
                );
                break;
*/
            case 'header-logo' :
                $template = Template::getTemplate(
                    'theme/' . self::THEME_ID . '/header-logo.tpl',
                    self::EXTENSION_ID
                );
                break;
/*
            case 'footer' :
                $template = Template::getTemplate(
                    'theme/' . self::THEME_ID . '/footer.tpl',
                    self::EXTENSION_ID
                );
                break;
            ...
            case 'login-message' :
                $template = Template::getTemplate(
                    'theme/' . self::THEME_ID . '/login-message.tpl',
                    self::EXTENSION_ID
                );
                break;
  */              
